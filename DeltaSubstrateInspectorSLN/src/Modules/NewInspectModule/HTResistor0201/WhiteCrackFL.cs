...
namespace DeltaSubstrateInspector.src.Modules.NewInspectModule.HTResistor0201
{
    ...
    {
        // ==================================================================================
        public HObject WhiteCrackFL(HObject ho_image, float th_scale, int crack_width, bool vert_close, int area_lower, int area_upper)
        {
            // Local iconic variables 
            HObject ho_Region, ho_ConnectedRegions, ho_RegionOpening, ho_SelectedRegions;
            ...
            ho_Region.Dispose();
            ho_Region = F_LocalThresholding(ho_image, "dark", 64, th_scale);

            ho_RegionOpening.Dispose();
            ho_RegionOpening = F_CrackSegmentation(ho_Region, crack_width, vert_close);
