...
namespace DeltaSubstrateInspector.src.Modules.NewInspectModule.HTResistor0201
{
    ...
    {
        // ==================================================================================
        public HObject BlackCrackFL(HObject ho_image, float th_scale, int crack_height, bool vert_close, int area_lower, int area_upper)
        {
            ...
            ho_Region.Dispose();
            ho_Region = F_LocalThresholding(ho_image, "light", 64, th_scale);

            ho_RegionOpening.Dispose();
            ho_RegionOpening = F_CrackSegmentation(ho_Region, crack_height, vert_close);
