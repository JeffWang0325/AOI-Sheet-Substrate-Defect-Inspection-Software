...
namespace DeltaSubstrateInspector.src.Modules.NewInspectModule.InductanceInsp
{
    public partial class FormThresholdAdjust : Form
    {
        ...
        public FormThresholdAdjust(HObject pmSrcImg, int ThMin,int ThMax, enType UseType)
        {
            ...
            rangeSliderTh.RangeMax = ThMax;
            rangeSliderTh.RangeMin = ThMin;
            SelectType(UseType);
        }
        ...
        private void NumUpDownThreshold_ValueChanged(object sender, EventArgs e)
        {
            ...
            rangeSliderTh.RangeMin = ThresholdValueMin;
            rangeSliderTh.Refresh();
        ...
        private void NumUpDownThresholdMax_ValueChanged(object sender, EventArgs e)
        {
            ...
            rangeSliderTh.RangeMax = ThresholdValueMax;
            rangeSliderTh.Refresh();
            HOperatorSet.ClearWindow(DisplayWindow.HalconWindow);
        ...
        private void rangeSliderTh_Scroll(object sender, EventArgs e)
        {
            NumUpDownThresholdMin.Value = decimal.Parse(rangeSliderTh.RangeMin.ToString());
            NumUpDownThresholdMax.Value = decimal.Parse(rangeSliderTh.RangeMax.ToString());
        }
